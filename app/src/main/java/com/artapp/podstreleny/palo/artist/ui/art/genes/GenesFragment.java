...
public class GenesFragment extends Fragment implements SharedPreferences.OnSharedPreferenceChangeListener {

    private static final String TAG = GenesFragment.class.getSimpleName();
    ...
    private GenesViewModel mViewModel;
    private GeneListAdapter mAdapter;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new GeneListAdapter(this, getActivity());
        mRecyclerView.setLayoutManager(new GridLayoutManager(context, 2));
        mRecyclerView.setHasFixedSize(true);
        mRecyclerView.setAdapter(mAdapter);

        mViewModel = ViewModelProviders.of(this).get(GenesViewModel.class);
        mViewModel.getGenes().observe(this, new Observer<PagedList<Gene>>() {
            @Override
            public void onChanged(@Nullable PagedList<Gene> genes) {
                if (genes != null) {
